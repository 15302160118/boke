<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:80:"D:\phpStudy1\WWW\boke\public/../application/admin\view\article\search_admin.html";i:1528290867;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<body>
  <form action="search_admin" onsubmit="return check()"; method='post'>
    ...
    <button class="layui-btn layui-btn-primary anniu" type='submit'><i class="fa fa-search" aria-hidden="true"></i></button><button class="layui-btn layui-btn-primary anniu"><i class="fa fa-undo" aria-hidden="true"><a href="<?php echo url('article_admin'); ?>">返回</a></i></button>   
  </form>
