<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:77:"D:\phpStudy1\WWW\boke\public/../application/admin\view\article\add_admin.html";i:1528083995;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset='UTF-8'>
...
<body>
	<form class="layui-form" action="<?php echo url('save_admin'); ?>" method="post"  enctype="multipart/form-data">
