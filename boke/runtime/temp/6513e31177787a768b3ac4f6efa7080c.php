<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:74:"D:\xampp\htdocs\boke\public/../application/admin\view\category\search.html";i:1527511769;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<fieldset class='layui-elem-field layui-field-title' >
  ...
  <form action="search" onsubmit="return check()"; method='post'>
    <input type="text" id='select' name="categoryname"  placeholder="请输入要查询的文章类别或其关键字" autocomplete="off" class="layui-input" value="<?php echo input('post.realname'); ?>">
