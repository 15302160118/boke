<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:71:"D:\phpStudy1\WWW\boke\public/../application/admin\view\index\index.html";i:1528641817;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree"  lay-filter="test">
                ...
                <li class="layui-nav-item">
                 ...
                 <li class="layui-nav-item">
                    <a onclick='boke()' href="<?php echo url('boke/index'); ?>">博客页面</a>
                </li>
            </ul>
        </div>
    </div>
