<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:73:"D:\phpStudy1\WWW\boke\public/../application/admin\view\author\search.html";i:1527410050;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<fieldset class='layui-elem-field layui-field-title' >
  ...
  <form action="search" onsubmit="return check()"; method='post'>
    <input type="text" id='select' name="realname"  placeholder="请输入要查询的真实姓名或其关键字" autocomplete="off" class="layui-input" value="<?php echo input('post.realname'); ?>">
    <button class="layui-btn layui-btn-primary anniu" type='submit'><i class="fa fa-search" aria-hidden="true"></i></button><button class="layui-btn layui-btn-primary anniu"><i class="fa fa-undo" aria-hidden="true"><a href="<?php echo url('index'); ?>">返回</a></i></button>   
  </form>
